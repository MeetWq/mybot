...
def get_sub_list(group_id: str) -> dict:
    sub_list = load_sub_list()
    if group_id not in sub_list:
        return {}
    return sub_list[group_id]


def add_sub_list(group_id: str, room_id: str, up_name: str) -> str:
    sub_list = load_sub_list()
    group_sub_list = {}
    if group_id in sub_list:
        group_sub_list = sub_list[group_id]
    if room_id in group_sub_list:
        return 'dupe'
    group_sub_list[room_id] = up_name
    sub_list[group_id] = group_sub_list
    dump_sub_list(sub_list)
    return 'success'


def del_sub_list(group_id: str, room_id: str) -> str:
    sub_list = load_sub_list()
    group_sub_list = {}
    if group_id in sub_list:
        group_sub_list = sub_list[group_id]
...
def clear_sub_list(group_id: str) -> str:
    sub_list = load_sub_list()
    sub_list.pop(group_id)
    dump_sub_list(sub_list)
    return 'success'
